...
0. provide explanations of the first maps

1. Add markers for notable things talked about in the write-up.
...
### Income Inequality Over Time in King County 
...
#### Distribution of Median Income, 2009-2018
```{r, warning=FALSE}
...
#### Distribution of Whites in Seattle in 2018
```{r, warning=FALSE}
...
####Distribution of Blacks in Seattle in 2018
```{r, warning=FALSE}
...
#### Distribution of Asians in Seattle in 2018
```{r, warning=FALSE}
...
#### Distribution of Native Americans in Seattle in 2018
```{r, warning=FALSE}
raceMap(native_american_var, 2018, "Native Americans",
        c(0, 25, 50, 75, 100, 125, 150, 175, 200))
```

### Distribution of Pacific Islanders

#### Distribution of Pacific Islanders in Seattle in 2018
```{r, warning=FALSE}
...
#### Distribution of Hispanics in Seattle in 2014
```{r, warning=FALSE}
get_lang_map(spanish_var, "Hispanics", 2014,
             c(0, 500, 1000, 1500, 2000))
```

### Distribution of Cambodians
...
#### Distribution of Cambodians in Seattle in 2014
```{r, warning=FALSE}
...
#### Distribution of Hmong in Seattle in 2014
```{r, warning=FALSE}
...
#### Distribution of Vietnamese in Seattle in 2014
```{r, warning=FALSE}
