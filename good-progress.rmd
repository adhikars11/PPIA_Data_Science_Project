...
Shockingly, or perhaps not, this map shows that Blacks are primarily where Whites are not. **Generally, anywhere where Blacks are, Whites are not.**
...
These visualizations demonstrate that there is a pattern between income lines in Seattle and racial lines. **Whites were primarily located in areas where Blacks and Asians weren't.**
